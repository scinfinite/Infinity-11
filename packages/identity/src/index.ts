...
import type { DatabaseProvider, ProjectRecord, Role, WorkspaceRecord } from '@infinity-11/persistence';
...
const correlation=(userId:string,workspaceId?:string,projectId?:string):CorrelationContext=>{const value:CorrelationContext={correlationId:randomUUID(),actorId:userId};if(workspaceId)value.workspaceId=workspaceId;if(projectId)value.projectId=projectId;return value;};
